...
The cardano-cli project is committed to ensuring the security of
...
- The version of cardano-cli where the vulnerability exists.
...
The cardano-cli project greatly appreciates the assistance of the security
