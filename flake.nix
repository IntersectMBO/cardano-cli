      ...
      system: let
              ...
              (
                {
                  ...
                  lib.mkIf pkgs.stdenv.hostPlatform.isDarwin {
                    packages.cardano-cli.components.exes.cardano-cli.postInstall = lib.mkAfter (
                      let
        ...
        flake = cabalProject.flake (
          lib.optionalAttrs (system == "x86_64-linux") {
            ...
            variants =
              lib.genAttrs [crossCompilerVersionMusl crossCompilerVersionUcrt64 haddockCompiler]
              (compiler-nix-name: {
