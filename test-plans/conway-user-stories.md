...
| Generates a registration certificate compliant with the Conway CDDL. | The cborHex of the certificate complies with the format specified on the cddl `reg_drep_cert = (16, drep_credential, coin, anchor / null)`|
