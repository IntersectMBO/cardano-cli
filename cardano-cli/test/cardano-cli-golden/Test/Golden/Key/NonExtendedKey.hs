...
-- expected result.
tasty_golden_KeyNonExtendedKey_GenesisExtendedVerificationKey :: UnitIO ()
tasty_golden_KeyNonExtendedKey_GenesisExtendedVerificationKey =
...
-- | Test that converting a @cardano-address@ Byron signing key yields the
-- expected result.
tasty_golden_KeyNonExtendedKey_StakeExtendedVerificationKeyShelley :: UnitIO ()
tasty_golden_KeyNonExtendedKey_StakeExtendedVerificationKeyShelley =
  H.moduleWorkspace "tmp" $ \tempDir -> do
    genesisVKeyFp <-
...
-- expected result.
tasty_golden_KeyNonExtendedKey_DRepExtendedVerificationKey :: UnitIO ()
tasty_golden_KeyNonExtendedKey_DRepExtendedVerificationKey =
  H.moduleWorkspace "tmp" $ \tempDir -> do
    extendedKeyFile <-
...
-- expected result.
tasty_golden_extended_payment_vkey_to_non_extended_vkey :: UnitIO ()
tasty_golden_extended_payment_vkey_to_non_extended_vkey =
  H.moduleWorkspace "tmp" $ \tempDir -> do
    extendedKeyFile <-
...
tasty_golden_extended_cc_vkey_to_non_extended_vkey :: UnitIO ()
tasty_golden_extended_cc_vkey_to_non_extended_vkey =
  let supplyValues = ["cc-cold.vkey", "cc-hot.vkey"]
   in forM_ supplyValues $ \suffix ->
        H.moduleWorkspace "tmp" $ \tempDir -> do
          extendedKeyFile <-
