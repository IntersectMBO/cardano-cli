...
import Hedgehog.Extras.Test (moduleWorkspace)
...
tasty_golden_view_babbage_yaml :: UnitIO ()
tasty_golden_view_babbage_yaml =
...
tasty_golden_view_metadata :: UnitIO ()
tasty_golden_view_metadata =
  moduleWorkspace "tmp" $ \tempDir -> do
...
tasty_golden_view_conway_proposal :: UnitIO ()
tasty_golden_view_conway_proposal = do
