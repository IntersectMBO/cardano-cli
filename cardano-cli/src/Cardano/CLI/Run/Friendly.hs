...
friendlyCertificate =
  object
    ...
    . \case
      ...
      Api.CommitteeDelegationCertificate coldKeyHash hotKeyHash ->
        "committee member hot key registration" .= object
          [ "cold key hash" .= serialiseToRawBytesHexText coldKeyHash
          , "hot key hash" .= serialiseToRawBytesHexText hotKeyHash
          ]

      Api.CommitteeHotKeyDeregistrationCertificate coldKeyHash ->
        "committee member hot key deregistration" .= object
          [ "cold key hash" .= serialiseToRawBytesHexText coldKeyHash
          ]
