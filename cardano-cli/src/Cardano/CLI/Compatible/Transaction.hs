...
instance Exception CompatibleTransactionError
...
-- TODO: Convert all error throwing function to use
-- CustomCliException. This will give us a callstack.
-- Note that we would to propagate the HasCallStack
