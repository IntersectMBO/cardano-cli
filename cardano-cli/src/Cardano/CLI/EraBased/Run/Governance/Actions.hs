...
runGovernanceActionCreateConstitutionCmd
  Cmd.GovernanceActionCreateConstitutionCmdArgs
    ...
    let prevGovActId =
        ...
        sbe :: ShelleyBasedEra era = convert eon
  ...
  caseShelleyToBabbageOrConwayEraOnwards
    ( \sToB -> do
        let oFp = uppFilePath eraBasedPParams'
            anyEra = AnyShelleyBasedEra (convert sToB :: ShelleyBasedEra era)
    ...
    ( \conwayOnwards -> do
        let oFp = uppFilePath eraBasedPParams'
            anyEra = AnyShelleyBasedEra (convert conwayOnwards :: ShelleyBasedEra era)
