    ...
    OnDiskPlutusScript
      (OnDiskPlutusScriptCliArgs plutusScriptFp mScriptDatum redeemerFile execUnits) -> do
        AnyPlutusScript script <-
          readFilePlutusScript (unFile plutusScriptFp) (useEra @era)
  ...
  case lang of
    L.SPlutusV1 ->
      throwCliError @String
        "handlePotentialScriptDatum: You must procide a script datum for Plutus V1 scripts."
    L.SPlutusV2 ->
      throwCliError @String
        "handlePotentialScriptDatum: You must procide a script datum for Plutus V2 scripts."
