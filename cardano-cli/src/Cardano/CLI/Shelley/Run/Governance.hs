...
runGovernanceGenesisCmd :: GovernanceGenesisCmd -> ExceptT ShelleyGovernanceCmdError IO ()
runGovernanceGenesisCmd = \case
...
runGovernanceCmd = \case
  GovernanceGenesisCmd cmd -> runGovernanceGenesisCmd cmd
